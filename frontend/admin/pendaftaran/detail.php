<?php
        ...
        // Query ambil data detail (JOIN ke tabel kelas untuk menampilkan nama kelas tujuan pindahan)
        $query = mysqli_query($conn, "SELECT p.*, k.nama_kelas AS nama_kelas_pindahan
            FROM pendaftaran p
            LEFT JOIN kelas k ON p.kelas_pindahan = k.id
            WHERE p.id = '$id'");
        ...
        $is_pindahan = ($data['jenis_pendaftaran'] ?? 'reguler') === 'pindahan';
        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Detail Pendaftaran Siswa
                                        <?php if ($is_pindahan): ?>
                                        <span class="badge bg-info ms-2">Jalur Pindahan</span>
                                        <?php else: ?>
                                        <span class="badge bg-primary ms-2">Jalur Reguler</span>
                                        <?php endif; ?>
                                    </h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="card">
                                                <div class="card-header bg-info text-white">
                                                    <div class="card-title text-white">Data Pindahan
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            <th width="30%">Asal Sekolah Pindahan</th>
                                                            <td><?= decryptData($data['asal_sekolah_pindahan']) ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Kelas Tujuan</th>
                                                            <td><?= htmlspecialchars($data['nama_kelas_pindahan'] ?? 'Belum diketahui') ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Surat Pindahan</th>
                                                            <td>
                                                                <?php if (!empty($data['surat_pindahan'])): ?>
                                                                <button type="button"
                                                                    class="btn btn-outline-info btn-sm"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#modalSuratPindahan">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <?php if ($is_pindahan): ?>
                                                    <button type="button" class="btn btn-outline-info mb-2 w-100"
                                                        data-bs-toggle="modal" data-bs-target="#modalSuratPindahan">
                                                        <i class="fas fa-file-pdf"></i> Lihat Surat Pindahan
                                                    </button>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <iframe src="../../../backend/<?= $data['foto_kk'] ?>" width="100%" height="500px">
                                    </iframe>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <iframe src="../../../backend/<?= $data['ktp_ortu'] ?>" width="100%" height="500px">
                                    </iframe>
                    ...
                    <?php if ($is_pindahan): ?>
                    <div class="modal fade" id="modalSuratPindahan" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Surat Pindahan -
                                        <?= decryptData($data['nama_lengkap']) ?>
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <iframe src="../../../backend/<?= $data['surat_pindahan'] ?>" width="100%"
                                        height="500px">
                                    </iframe>
                                    ...
                                    <div class="alert alert-warning">
                                        <i class="bi bi-exclamation-triangle"></i>
                                        File surat pindahan belum tersedia.
                                    </div>
